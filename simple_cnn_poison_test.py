...
sess = K.get_session()
model = SimpleCNN(input_shape=(3,32,32))
...
test_index_to_flip = correct_indices[0:7]
print(test_index_to_flip)

# plt.imshow(np.transpose(x_test[test_index_to_flip], (1,2,0)))
# plt.show()

z_test_bottleneck_list = [(test_bottleneck_features[test_index_to_flip], y_test[test_index_to_flip])]
print(z_test_bottleneck_list[0].shape)
exit()
